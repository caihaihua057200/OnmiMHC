...
peptide = peptide_TEST.str.slice(start=-21).str.upper().str.pad(width=21, side='right', fillchar='-')
...
for f in tqdm(range(5)):
    ...
    class model(nn.Module):
        def __init__(self,
            ...
            self.f_model = nn.Sequential(nn.Linear(11752, fc1_size),  # 4624   4424+2688+704
        ...
        def forward(self, x, z, b):
            x = x.view(x.shape[0], 21, -1)  # P_SEQ
            z = z.view(x.shape[0], 55, -1)  # P+ALLELE
